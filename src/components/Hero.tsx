  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-hero">
      ...
      <div className="absolute inset-0 opacity-20">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-tech-secondary/20 rounded-full blur-3xl animate-glow-pulse" style={{ animationDelay: '1.5s' }} />
      </div>

      <div className="container relative z-10 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center space-y-8 animate-slide-up">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-tech border border-primary/20 backdrop-blur-sm">
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-tech font-bold tracking-tight">
            ...
            <span className="block bg-gradient-to-r from-primary via-tech-secondary to-primary bg-clip-text text-transparent animate-glow-pulse">
              PC-Lösungen
            </span>
          </h1>
          ...
          <div className="grid grid-cols-3 gap-8 pt-12 max-w-2xl mx-auto">
            <div className="space-y-2">
              <div className="text-3xl font-tech font-bold text-primary">500+</div>
              <div className="text-sm text-muted-foreground">Zufriedene Kunden</div>
            </div>
            <div className="space-y-2">
              <div className="text-3xl font-tech font-bold text-primary">100%</div>
              <div className="text-sm text-muted-foreground">Qualitätsgarantie</div>
            </div>
            <div className="space-y-2">
              <div className="text-3xl font-tech font-bold text-primary">24/7</div>
